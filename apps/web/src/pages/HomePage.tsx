...
import { Plus, FileText, Trash2, LogOut, Network, GitBranch, LayoutTemplate } from 'lucide-react'
    ...
    <div className="min-h-screen bg-surface-bg">
      ...
      <aside className="fixed left-0 top-0 h-full w-56 bg-white border-r border-gray-200 flex flex-col p-4">
        ...
        <nav className="flex flex-col gap-1 flex-1">
          ...
          <button onClick={() => navigate('/templates')} className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-surface-offset transition-colors mt-2">
        ...
        <div className="border-t border-gray-100 pt-3">
          ...
          <button onClick={() => { logout(); navigate('/auth') }} className="flex items-center gap-1.5 text-xs text-gray-500 hover:text-red-500 transition-colors">
